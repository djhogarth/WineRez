        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_StreetNumberAndName = table.Column<string>(type: "text", nullable: true),
                    ShipToAddress_City = table.Column<string>(type: "text", nullable: true),
                    ShipToAddress_StateOrProvince = table.Column<string>(type: "text", nullable: true),
